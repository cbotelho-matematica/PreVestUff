...
\begin{document}
    ...
    \begin{frame}{Classificação de Ângulos}
        ...
        \begin{tabular}{p{.2\linewidth} p{.2\linewidth} p{.2\linewidth} p{.2\linewidth}}
            ...
            \includegraphics[width=.2\columnwidth]{angulo_agudo.jpeg} & \includegraphics[width=.2\columnwidth]{angulo_reto.jpeg} & \includegraphics[width=.2\columnwidth]{angulo_obtuso.jpeg} & \includegraphics[width=.2\columnwidth]{angulo_raso.jpeg}\\
    ...
    \begin{frame} {Exercícios} %Gabarito A
        \begin{columns}
            ...
            \begin{column}{.9\textwidth} %letra a
                1.~\textbf{(UNESP-1996): } Os lados de um triângulo medem, respectivamente, 7 cm, 9 cm e 14 cm. Qual é o perímetro do triângulo semelhante ao dado cujo lado maior é de 21 cm?
